...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(v -> {
            ...
            TextView textView8Email = findViewById(R.id.textView8);
            TextView colVoEmail = findViewById(R.id.col_vo);
            TextView cenaEmail = findViewById(R.id.cena);
            TextView nameEmail = findViewById(R.id.name_of_zakz);

            String messageBody = "Имя заказчика: " + nameEmail.getText() + "\n" +
                    "Товар в корзине: " + textView8Email.getText() + "\n" +
                    "Количество товара: " + colVoEmail.getText() + "\n" +
                    "Цена заказа: " + cenaEmail.getText();
            ...
            if (isIntentSafe) {
                ...
                // Обработка случая, когда отсутствует почтовое приложение
            }
        });
    }
}
